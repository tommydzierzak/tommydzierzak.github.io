  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/headers/">Extracuirricular</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/design/header-image-color/">Enable UC</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/documentation/">Projects</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/roadmap/">Home Assistant</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Thomas Dzierzak – A Flexible Student Looking For a Co-op">
				<img src="http://localhost:4000/assets/img/logo.png" alt="Thomas Dzierzak – A Flexible Student Looking For a Co-op">
			</a>
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Website for and by Thomas Dzierzak. Based on <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a> by <a href="http://phlow.de/">Phlow</a>.</p>
          </section>
